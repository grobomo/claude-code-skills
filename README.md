...
| **claude-report** | Generate inventory reports for MCP servers, skills, and hooks. HTML output with search and filtering. | `claude plugin install claude-report@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/claude-report) |
| **cloud-claude** | Launch Claude Code on AWS EC2 spot instances. Auto-provisions SSH keys, security groups, Docker container with Chrome and MCP support. | `claude plugin install cloud-claude@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/cloud-claude) |
...
| **hook-runner** | Modular hook runner for Claude Code. Workflows group modules into enforceable pipelines — spec gates, commit quality, destructive guards, session lifecycle. 95+ modules. | `claude plugin install hook-runner@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/hook-runner) |
| **jumpbox** | Windows EC2 jumpbox manager. Provisions Win Server 2022 with Chrome, Git Bash, SSM. RDP with auto credential injection. | `claude plugin install jumpbox@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/jumpbox) |
...
| **openclaw** | Talk to local OpenClaw instances via HTTP API. OpenAI-compatible chat completions endpoint running in WSL. | `claude plugin install openclaw@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/openclaw) |
| **openclaw-setup** | Repeatable OpenClaw deployment with guided setup, secure secret management, and CI/fleet automation. | `claude plugin install openclaw-setup@grobomo-marketplace` | [GitHub](https://github.com/grobomo/claude-code-skills/tree/main/plugins/openclaw-setup) |
