...
- [ ] T004: Sync hook-runner v2.26.0 to marketplace — PRs #351 + #352 (commit-counter branch awareness, hook-editing-gate expansion, publish-json-guard creation mode, openclaw-tmemu-guard, stop-message.txt sync, worktree-gate refactor)
