...
Trend Micro Vision One API - skill (280+ ops via executor.py) + MCP server (75 ops via server.py). Alerts, endpoints, threats, cloud security, response actions.

## Install

```bash
claude plugin marketplace add grobomo/claude-code-skills
claude plugin install v1-api@grobomo-marketplace --scope user
```
