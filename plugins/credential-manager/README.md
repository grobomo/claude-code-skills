...
Store and retrieve API tokens/secrets in OS credential store (Windows Credential Manager / macOS Keychain). GUI popup for zero-friction secure storage.
...
claude plugin install credential-manager@grobomo-marketplace --scope user
```
